...
import { StatChartData, useChartsTheme, GraphSeries } from '@perses-dev/components';
...
export function StatChartPanel(props: StatChartPanelProps) {
  ...
  console.log('StatchartPanel, Queryresults : ', queryResults);
  ...
  console.log('StatChartPanel, CheckPoint1')


  // if (contentDimensions === undefined) return null;


  console.log('StatChartPanel, CheckPoint2')
  ...
  return (
    ...
    //     statChartData.map((series, index) => (
      <>
        <h1> hello world </h1>
        {console.log('StatChartPanel Checkpoint 3')}
                <StatChart
            key={index}
            width={0}
            height={0}
